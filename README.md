...
1. **Descargar la extension**
    ...
    - Abrir el archivo [EI-Links.rar](https://github.com/MITH-arg/EI-Links/blob/main/EI-Links.rar)
    
    - Una vez abierto darle a ***descargar*** | ***download***

    <img src="./media/tutorial_instalacion/paso-1.png" alt="tutorial paso 1" style="width: 75%;"/>
...
1. **Guardar la extension**
    ...
    <img src="./media/tutorial_instalacion/paso-2.png" alt="tutorial paso 2" style="width: 75%;"/>
...
1. **Configurar el navegador**
    ...
    <img src="./media/tutorial_instalacion/paso-3.png" alt="tutorial paso 3" style="width: 75%;"/>

    - Habilitar el modo desarrollador

    > Esquina superior derecha
    
    <img src="./media/tutorial_instalacion/paso-4.png" alt="tutorial paso 4" style="width: 75%;"/>
...
1. **Cargar la extension**
    ...
    <img src="./media/tutorial_instalacion/paso-5.png" alt="tutorial paso 5" style="width: 75%;"/>
...
1. **Configuracion final**
    ...
    <img src="./media/tutorial_instalacion/paso-6.png" alt="tutorial paso 6" style="width: 75%;"/>


1. **Ya esta lista para usar**

    <img src="./media/tutorial_instalacion/paso-7.png" alt="tutorial paso 7" style="width: 75%;"/>
